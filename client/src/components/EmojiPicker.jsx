...
const CATEGORIES = [
  ...
  { icon: "👋", label: "Жесты", emojis: ["👋","🤚","✋","👌","✌","🤞","🤟","🤘","🤙","👈","👉","👆","👇","☝","👍","👎","✊","👊","🤛","🤜","👏","🙌","👐","🤲","🤝","🙏","✍","💪","👀","👅","👄"] },
  { icon: "❤️", label: "Сердца", emojis: ["❤️","🧡","💛","💚","💙","💜","🖤","🤍","🤎","💔","❣️","💕","💞","💓","💗","💖","💘","💝","💯","💢","💥","💫","💦","💨","💬","💭","💤"] },
  { icon: "🎉", label: "Активность", emojis: ["🎉","🎊","🎈","🎁","🎀","🏆","🥇","🥈","🥉","🎯","🎱","🎮","🕹","🎰","🎲","🧩","🧸","⚽","🏀","🏈","⚾","🥎","🏐","🏉","🎾","🏸","🥊","🥋","⛸","🛷","🛹"] },
  { icon: "🐶", label: "Животные", emojis: ["🐶","🐱","🐭","🐹","🐰","🦊","🐻","🐼","🐨","🐯","🦁","🐮","🐷","🐸","🐵","🙈","🙉","🙊","🐔","🐧","🐦","🦆","🦅","🦉","🦇","🐺","🐴","🦄","🐝","🦋","🐌","🐞","🐜","🦟","🦗","🕷","🦂","🐢","🐍","🦎","🐙","🐬","🐳","🐋","🦈","🐊","🐘","🦒","🐕","🐈","🐇","🦔"] },
  { icon: "🍕", label: "Еда", emojis: ["🍕","🍔","🌭","🍟","🌮","🌯","🥗","🍝","🍜","🍣","🍱","🥟","🍤","🥚","🍳","🥞","🧇","🥓","🥩","🍗","🍖","🌽","🥦","🥕","🥐","🍞","🧀","🍰","🎂","🧁","🍩","🍪","🍫","🍬","🍭","🍿","☕","🍵","🧃","🥤","🧋","🍺","🍻","🥂","🍷","🥃","🍹","🍾"] },
  { icon: "✈️", label: "Путешествия", emojis: ["✈️","🚀","🛸","🚁","🚂","🚄","🚗","🚕","🚌","🚎","🚑","🚒","🚓","🏎","🏍","🛵","🚲","🛴","🛹","⛵","🚢","🛥","🏖","🏝","🏕","🗺","🌍","🌎","🌏","🗼","🏰","🏯","🗽","🗿","⛩"] },
  { icon: "💡", label: "Символы", emojis: ["💡","🔥","❄","⭐","🌟","✨","💥","🌈","🌊","⚡","☔","🌀","🌪","🔑","🔒","🔓","🔔","🔇","🔊","🎵","🎶","📱","💻","🖥","📷","📸","📹","🎥","📺","🔭","🔬","💊","🔧","🔨","⚒","🛠","🧲","🕯","🔦","🪄","🎭","🎨","🖌","✏","📝","📚","📖","📌","📍","🗑","💰","💳","💎","🏷"] },
];
